...
<div id="smakk-page-wrapper" class="smakk-page-<%=PortalSettings.ActiveTab.BreadCrumbs(0).TabName.toLower.Replace(" ","_")%>">
        ...
        <div id="smakk-header">
            <div id="smakk-nav">
               <div id="navLogo"><a href="/"></a></div>
                <dnn:SMaKKSitesNav  runat="server">
                </dnn:SMaKKSitesNav>
            </div>
        </div>
    </div>
    <div id="smakk-hero-outer-wrapper">
      ...
      <div class="heroImage" id="heroImage" runat="server">
        ...
        <div class="heroShaddow"></div>
        
    </div>
    <div id="smakk-content-wrapper">
           <div class="gradContainer"><div id="smakk-content">
     
           <div id="ContentPane" class="ContentPane" runat="server"></div>
            <div class="clear">
            </div>
             <div id="leftPane" class="leftPane" runat="server"></div> <div id="rightPane" class="rightPane" runat="server"></div>
              <div class="clear">
            </div>
             </div>
             <div class="clear">
        ...
        <img alt="Im so glad you found us" src="/portals/_default/skins/Sprout/images/ourstory/imsoglad.png" />
        <div class="bottomContent" id="bottomContent" runat="server"></div>
        <img alt="Adina" src="/portals/_default/skins/Sprout/images/ourstory/Adina.png" />
        </div>
