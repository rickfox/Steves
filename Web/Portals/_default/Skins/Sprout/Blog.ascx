...
<div id="smakk-page-wrapper" class="smakk-page-<%=PortalSettings.ActiveTab.BreadCrumbs(0).TabName.toLower.Replace(" ","_")%>">
   ...
   <div class="register">Grow with us! Sign up to receive newsletter updates and special offers:
        ...
        <iframe src="/SubscribeForm.htm"  WIDTH=265 HEIGHT=65 frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                    ...
                    <div class="middleSection" id="middleSection" runat="server">
...
<script runat="server">
    ...
    Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
        ...
        Page.ClientScript.RegisterClientScriptInclude("blog_script", SkinPath & "scripts/blog.js")
