    ...
    <div id="smakk-header-wrapper">
      ...
      <div id="smakk-hero-outer-wrapper">
        <div id="smakk-hero-wrapper">
            <div class="heroContainer" id="hero_content_pane" >
            </div>
        </div>
        <div class="herodots  left_dots"></div><div id="herotextimg"><img src="<%=SkinPath %>images/About/hero_title.png" /></div><div class="herodots right_dots"></div> <div class="clear"></div> 
    </div>
    <div id="smakk-content-wrapper">
        <div id="smakk-content">
               <div class="pageContentWrapper">
                ...
                <div id="Quote" class="Quote" runat="server"></div>
                <div id="BottomContentPane" class="BottomContentPane" runat="server"></div>
         ...
         <div id="topimgs">
             <img class="imgleft" src="<%=SkinPath %>images/About/about_chocolate.png" /><img class="imgright" src="<%=SkinPath %>images/About/about_blueberries.png" /></div>
         <div id="leftimg">
             <img src="<%=SkinPath %>images/About/about_honeystick.png" /></div>
          <div id="rightimg">
              <img src="<%=SkinPath %>images/About/about_donut.png" /></div>
          <div id="BottomSection" class="BottomSection" runat="server"></div>
          
          <div id="slideholder">
          <div class="slidernav left">
          <a href="#">
              <img src="<%=SkinPath %>images/About/nav_arrow_left.png" data-svgswap="<%=SkinPath %>images/About/nav_arrow_left.svg" /></a>
          </div>
          <div id="Scroller" class="Scroller" runat="server"></div>
          <div class="slidernav right">
          <a href="#" >
              <img src="<%=SkinPath %>images/About/nav_arrow_right.png" data-svgswap="<%=SkinPath %>images/About/nav_arrow_right.svg"/></a></div>
          </div>
   </div>
   <div id="cta" class="cta" runat="server"></div>
</div>
...
<script runat="server">
    ...
    Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
        ...
        Page.ClientScript.RegisterClientScriptInclude("about", SkinPath & "scripts/about.js")
