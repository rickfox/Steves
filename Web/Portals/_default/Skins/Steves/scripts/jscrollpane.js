...
﻿  ﻿  ﻿  ﻿  $this.wrap(
﻿  ﻿  ﻿  ﻿  ﻿  $('<div></div>').attr(
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  {'class':'jScrollPaneContainer ui-widget ui-widget-content'}
﻿  ﻿  ﻿  ﻿  ﻿  ).css(
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  {
...
﻿  ﻿  ﻿  ﻿  $container.append(
﻿  ﻿  ﻿  ﻿  ﻿  $('<div></div>').attr({'class':'jScrollPaneTrackHolder ui-widget-content ui-state-default'}).css({'width':(settings.scrollbarWidth+1)+'px'}).append(
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  $('<div></div>').attr({'class':'jScrollPaneTrack'}).css({'width':settings.scrollbarWidth+'px'}).append(
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  $('<div></div>').attr({'class':'jScrollPaneDrag ui-widget-content ui-state-default'}).css({width:(settings.scrollbarWidth-2)+'px'}).append(
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  $('<div></div>').attr({'class':'ui-icon ui-icon-grip-dotted-horizontal'}).css({width:settings.scrollbarWidth+'px', height:settings.scrollbarWidth+'px'})
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  )
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  )
﻿  ﻿  ﻿  ﻿  ﻿  )
﻿  ﻿  ﻿  ﻿  );
...
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  .append(
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  $('<a></a>')
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  .attr({'href':'javascript:;', 'class':'jScrollArrowUp ui-state-default', 'tabindex':-1})
...
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  $('<a></a>')
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  .attr({'href':'javascript:;', 'class':'jScrollArrowDown ui-state-default', 'tabindex':-1})
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  .css({width:settings.scrollbarWidth+'px', height: settings.scrollbarWidth+'px'})
...
﻿  ﻿  ﻿  ﻿  ﻿  $this.trigger('scroll');
﻿  ﻿  ﻿  ﻿  ﻿  if (settings.showArrows) {
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  $upArrow[destY == 0 ? 'addClass' : 'removeClass']('disabled ui-state-disabled');
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  $downArrow[destY == maxY ? 'addClass' : 'removeClass']('disabled ui-state-disabled');
﻿  ﻿  ﻿  ﻿  ﻿  }
﻿  ﻿  ﻿  ﻿  };
