...
<div id="smakk-page-wrapper" class="smakk-page-<%=PortalSettings.ActiveTab.BreadCrumbs(0).TabName.toLower.Replace(" ","_")%>">
    ...
    <div id="smakk-content-wrapper">
        <div id="smakk-content">
            <div id="partner_headline" class="partner-headline" runat="server">
            </div>
            <div id="left-column">
                <div id="partner_photo" class="partner-photo" runat="server">
                </div>
                <div id="partner_contact_info" class="partner-contact-info" runat="server">
                </div>
            </div>
            <div id="right-column">
            ...
            <div id="partner_divider">
                <img src="<%=SkinPath%>/images/partner-divider.gif" alt="partner-divider" />
            </div>
            <div id="partner_list" class="partner-list" runat="server">
            </div>
            <div class="clear">
            </div>
        </div>
...
<script runat="server"> 'for mega menu we need to register hoverIntent plugin, but
    Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
        ...
        Page.ClientScript.RegisterClientScriptInclude("default_skin_script", SkinPath & "scripts/partners.js")
    End Sub
</script> 