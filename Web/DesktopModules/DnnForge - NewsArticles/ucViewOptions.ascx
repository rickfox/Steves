			                        ...
			                        <asp:DataGrid ID="grdBasicPermissions" Runat="server" AutoGenerateColumns="False" ItemStyle-CssClass="Normal"
				                        ...
				                        <Columns>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblAutoApproveComment" Runat="server" EnableViewState="False" ResourceKey="AutoApproveComment" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
			                        ...
			                        <asp:DataGrid ID="grdFormPermissions" Runat="server" AutoGenerateColumns="False" ItemStyle-CssClass="Normal"
				                        ...
				                        <Columns>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblCategories" Runat="server" EnableViewState="False" ResourceKey="Category" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblExcerpt" Runat="server" EnableViewState="False" ResourceKey="Excerpt" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblImage" Runat="server" EnableViewState="False" ResourceKey="Image" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblLink" Runat="server" EnableViewState="False" ResourceKey="Link" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblPublishDate" Runat="server" EnableViewState="False" ResourceKey="PublishDate" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblExpiryDate" Runat="server" EnableViewState="False" ResourceKey="ExpiryDate" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblMeta" Runat="server" EnableViewState="False" ResourceKey="Meta" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblCustom" Runat="server" EnableViewState="False" ResourceKey="Custom" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
			                        ...
			                        <asp:DataGrid ID="grdAdminPermissions" Runat="server" AutoGenerateColumns="False" ItemStyle-CssClass="Normal"
				                        ...
				                        <Columns>
					                        ...
					                        <asp:TemplateColumn>
						                        <HeaderTemplate>
							                        &nbsp;
							                        <asp:Label ID="lblSiteTemplates" Runat="server" EnableViewState="False" ResourceKey="SiteTemplates" />&nbsp;
						                        </HeaderTemplate>
						                        <ItemTemplate>
