...
<div align="left">
    ...
    <div class="Normal" style="margin-left: 25px;">
        <asp:PlaceHolder ID="phArchives" runat="server"><a href="<%= GetCurrentLinkRss() %>" rel="nofollow"><img src="<%= Page.ResolveUrl("~/DesktopModules/DnnForge - NewsArticles/Images/rssbutton.gif") %>" alt="Latest RSS Link" border="0"  /></a>&nbsp;</asp:PlaceHolder>
    ...
    <asp:Repeater ID="rptCategories" Runat="server" EnableViewState="False">
	    ...
	    <ItemTemplate>
                <asp:PlaceHolder ID="phArchives" runat="server" Visible="<%# IsSyndicationEnabled() %>"><a href="<%# GetCategoryLinkRss(DataBinder.Eval(Container.DataItem, "CategoryID")) %>" rel="nofollow"><img src="<%# Page.ResolveUrl("~/DesktopModules/DnnForge - NewsArticles/Images/rssbutton.gif") %>" alt="Category RSS Link" border="0"  /></a>&nbsp;</asp:PlaceHolder>
    ...
    <asp:Repeater ID="rptAuthors" Runat="server" EnableViewState="False">
	    ...
	    <ItemTemplate>
                <asp:PlaceHolder ID="phArchives" runat="server" Visible="<%# IsSyndicationEnabled() %>"><a href="<%# GetAuthorLinkRss(DataBinder.Eval(Container.DataItem, "UserID")) %>" rel="nofollow"><img src="<%# Page.ResolveUrl("~/DesktopModules/DnnForge - NewsArticles/Images/rssbutton.gif") %>" alt="Author RSS Link" border="0" /></a>&nbsp;</asp:PlaceHolder>
    ...
    <asp:Repeater ID="rptMonth" Runat="server" EnableViewState="False">
	    ...
	    <ItemTemplate>
                <asp:PlaceHolder ID="phArchives" runat="server" Visible="<%# IsSyndicationEnabled() %>"><a href="<%# GetMonthLinkRss(DataBinder.Eval(Container.DataItem, "Month"), DataBinder.Eval(Container.DataItem, "Year")) %>" rel="nofollow"><img src="<%# Page.ResolveUrl("~/DesktopModules/DnnForge - NewsArticles/Images/rssbutton.gif") %>" alt="Month RSS Link" border="0" /></a>&nbsp;</asp:PlaceHolder>
